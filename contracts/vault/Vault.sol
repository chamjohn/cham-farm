...
import "../access/AccessControlDefended.sol";

/* 
    Source: https://github.com/iearn-finance/yearn-protocol/blob/develop/contracts/vaults/yVault.sol
*/
contract Vault is ERC20Upgradeable, AccessControlDefended {
    ...
    string internal constant _defaultNamePrefix = "Champ Vault ";
    string internal constant _symbolSymbolPrefix = "cv";
